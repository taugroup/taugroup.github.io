...
We are a dynamic, diverse, and interdisciplinary research group from the Visual Computing and Computational Media Section in the [School of Performance, Visualization and Fine Arts](https://pvfa.tamu.edu) at [Texas A&M University](https://tamu.edu/). Our group develops numerical and machine learning algorithms and tools to enable and accelerate digital transformation (DX) for a sustainable society.
